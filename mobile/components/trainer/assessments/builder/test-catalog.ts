// MIRROR OF web/src/components/assessments/builder/test-catalog.ts
// keep in sync — drift detectado em revisão.
//
// Difere do web SOMENTE em:
//   - imports de ícones (`lucide-react-native` em vez de `lucide-react`)
//   - tipo do icon: `LucideIcon` é importado do mesmo módulo
//
// Quando catalog mudar, abrir 2 PRs (1 web, 1 mobile) ou refletir mudança aqui
// imediatamente.
