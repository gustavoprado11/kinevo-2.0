import { View, Text, Alert, Linking, ScrollView, Platform } from "react-native";
        ...
        <>
            ...
            <ScrollView style={{ flex: 1, backgroundColor: "#f8fafc", paddingHorizontal: 20, paddingTop: 24 }}>
                ...
                {/*
                  ...
                  No Android não existe integração de saúde implementada (HealthKit é
                  iOS/Apple Watch nativo, em `mobile/targets/watch-app/`). O link
                  `x-apple-health://` também só existe em iPhone, então renderizar este
                  card em Android resultava em botão quebrado. Quando/se Health Connect
                  for implementado, adicionar a branch Android aqui. (abr/2026)
                */}
                {Platform.OS === "ios" && (
                    <>
                        <Text
