...
Para editar in-place use kinevo_update_workout_session / kinevo_update_workout_item / kinevo_delete_*; não recrie o programa só para mudar dias, nomes ou cargas. kinevo_get_program retorna scheduled_days, session_type, method_key, rounds, set_scheme e item_config (blocos cardio) de cada item para você ler antes de editar.
