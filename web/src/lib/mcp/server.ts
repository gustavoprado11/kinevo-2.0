...
• Bloco aeróbio: kinevo_add_cardio_to_session. Modo 'continuous' (alvo de tempo ou distância: esteira, bike, corrida outdoor, remo…) ou 'interval' (work/rest × rounds). Para editar um bloco existente: kinevo_update_workout_item com cardio_config.
