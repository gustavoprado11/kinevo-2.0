    ...
    return (
        <div className="fixed inset-0 z-float flex items-center justify-center p-4">
            ...
            <div className="relative bg-surface-card border border-k-border-primary rounded-2xl p-8 max-w-md w-full shadow-2xl">
                ...
                <button
                    onClick={handleDismiss}
                    className="w-full py-3 px-4 bg-primary hover:opacity-90 text-primary-foreground font-semibold rounded-control transition-all shadow-lg shadow-violet-500/20 text-sm"
                >
                    Entendi!
                </button>
            </div>
