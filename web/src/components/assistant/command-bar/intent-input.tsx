...
export const IntentInput = forwardRef<HTMLInputElement, IntentInputProps>(
    function IntentInput(
        ...
        return (
            <div className="flex items-center gap-3 border-b border-[#E8E8ED] px-[18px] py-[15px]">
                ...
                <input
                    ...
                    className="flex-1 border-0 bg-transparent text-[16.5px] text-[#1D1D1F] outline-none placeholder:text-[#AEAEB2] disabled:opacity-60"
                    autoFocus
                    aria-label="Comando para a IA"
                />
                <span className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-[#DDD2FB] bg-[#F4F1FE] px-2.5 py-1 text-[11.5px] font-bold text-[#7C3AED]">
