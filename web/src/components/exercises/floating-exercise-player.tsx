        ...
        <AnimatePresence>
            {isOpen && videoUrl && (
                <motion.div
                    ...
                    className="fixed bottom-6 right-6 w-96 z-float bg-surface-card/80 backdrop-blur-xl border border-k-border-primary rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden"
                >
                    {/* Header */}
