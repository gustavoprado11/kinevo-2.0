                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`flex flex-col items-center gap-1.5 p-3 rounded-xl border transition-all duration-150 ${
                                                    selected
                                                        ? 'border-[#7C3AED] dark:border-violet-500 bg-[#7C3AED]/5 dark:bg-violet-500/10'
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full rounded-xl border border-[#E8E8ED] dark:border-k-border-subtle bg-white dark:bg-surface-inset px-4 py-3 text-sm text-[#1D1D1F] dark:text-foreground placeholder-[#AEAEB2] dark:placeholder-muted-foreground/40 outline-none focus:border-[#7C3AED] dark:focus:border-violet-500 focus:ring-1 focus:ring-[#7C3AED]/20 dark:focus:ring-violet-500/20 transition-colors resize-none"
                                />
                            </div>
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#7C3AED] dark:bg-violet-600 hover:bg-[#6D28D9] dark:hover:bg-violet-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-semibold transition-colors"
                            >
                                {isSubmitting ? (
                                    <>
