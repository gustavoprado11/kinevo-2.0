/* AUTO-GERADO de Landing Page.dc.html (Claude Design) — NÃO editar à mão (ver scratchpad/build-landing.mjs).
...
<header style="position:sticky;top:0;z-index:20;backdrop-filter:saturate(180%) blur(14px);-webkit-backdrop-filter:saturate(180%) blur(14px);background:rgba(255,255,255,0.78);border-bottom:1px solid var(--kv-border-subtle)">
  <nav style="max-width:1180px;margin:0 auto;padding:0 24px;height:66px;display:flex;align-items:center;justify-content:space-between;gap:24px">
    <a href="#topo" style="display:flex;align-items:center;gap:10px">
      <span style="width:34px;height:34px;border-radius:9px;background:linear-gradient(135deg,#4f46e5,#7c3aed 55%,#a855f7);display:flex;align-items:center;justify-content:center;overflow:hidden;box-shadow:var(--kv-shadow-brand-sm)"><img src="/logo-icon.png" alt="Kinevo" style="width:100%;height:100%;object-fit:cover"></span>
    ...
    <div style="display:flex;align-items:center;gap:10px">
      <a href="https://www.kinevoapp.com/login" style="padding:9px 16px;font-size:14px;font-weight:600;color:var(--kv-text-secondary);border-radius:999px;transition:background .2s" onmouseover="this.style.background='var(--kv-neutral-100)'" onmouseout="this.style.background=''">Entrar</a>
      <a href="https://www.kinevoapp.com/signup" style="padding:10px 20px;font-size:14px;font-weight:600;color:#fff;background:var(--kv-brand-600);border-radius:999px;box-shadow:var(--kv-shadow-brand-sm);transition:transform .15s,box-shadow .2s" onmouseover="this.style.transform='translateY(-1px)';this.style.boxShadow='var(--kv-shadow-brand)'" onmouseout="this.style.transform='';this.style.boxShadow='var(--kv-shadow-brand-sm)'">Começar grátis</a>
    </div>
  </nav>
</header>

<!-- ░░░ HERO ░░░ -->
<section id="topo" style="position:relative;padding:84px 0 72px;background:radial-gradient(ellipse 90% 70% at 50% -20%,rgba(124,58,237,0.13),transparent 62%)">
  <div style="position:absolute;top:-60px;left:-80px;width:340px;height:340px;border-radius:50%;background:rgba(168,85,247,0.16);filter:blur(90px);pointer-events:none"></div>
  <div style="position:absolute;top:120px;right:-100px;width:360px;height:360px;border-radius:50%;background:rgba(79,70,229,0.14);filter:blur(100px);pointer-events:none"></div>
  <div id="hero-grid" style="position:relative;max-width:1180px;margin:0 auto;padding:0 24px;display:grid;grid-template-columns:1.04fr 1fr;gap:56px;align-items:center">
    <div>
      <div id="hero-eyebrow" style="display:inline-flex;align-items:center;gap:8px;padding:6px 12px 6px 8px;background:rgba(255,255,255,0.7);border:1px solid var(--kv-border-subtle);border-radius:999px;box-shadow:var(--kv-shadow-xs);margin-bottom:22px">
        <span style="display:inline-flex;align-items:center;gap:6px;padding:3px 9px;background:var(--kv-brand-600);color:#fff;border-radius:999px;font-size:11px;font-weight:700;white-space:nowrap;flex-shrink:0"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:13px;height:13px"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"/><path d="M20 2v4"/><path d="M22 4h-4"/><circle cx="4" cy="20" r="2"/></svg>Assistente de IA</span>
        <span style="font-size:13px;font-weight:600;color:var(--kv-text-secondary)">Prescreve, acompanha e recebe — num lugar só</span>
      </div>
      <h1 class="display-xl" style="font-size:56px;font-weight:800;line-height:1.06;letter-spacing:-0.03em;margin:0 0 20px;color:var(--kv-text-primary)">Tudo que o personal precisa pra trabalhar — <span style="background:linear-gradient(120deg,#7c3aed,#a855f7);-webkit-background-clip:text;background-clip:text;color:transparent">num lugar só.</span></h1>
      ...
      <div style="display:inline-flex;align-items:center;gap:9px;margin-bottom:22px;padding:8px 14px 8px 10px;background:var(--kv-success-soft);border:1px solid #BBE7C8;border-radius:999px">
      ...
      <div id="hero-cta" style="display:flex;flex-wrap:wrap;gap:14px;margin-bottom:18px">
        <a href="https://www.kinevoapp.com/signup" style="display:inline-flex;align-items:center;gap:9px;padding:15px 28px;font-size:16px;font-weight:700;color:#fff;background:var(--kv-brand-600);border-radius:999px;box-shadow:var(--kv-shadow-brand);transition:transform .15s" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform=''">Começar grátis<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></a>
        <a href="#como-funciona" style="display:inline-flex;align-items:center;gap:9px;padding:15px 24px;font-size:16px;font-weight:600;color:var(--kv-text-primary);background:#fff;border:1px solid var(--kv-border-default);border-radius:999px;transition:background .2s" onmouseover="this.style.background='var(--kv-neutral-100)'" onmouseout="this.style.background='#fff'"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:17px;height:17px;color:var(--kv-brand-600)"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"/></svg>Ver como funciona</a>
      </div>
    ...
    <div id="hero-visual" style="position:relative;min-height:440px">
      <!-- Dashboard window -->
      <div style="position:relative;z-index:2;width:100%;background:#fff;border:1px solid var(--kv-border-subtle);border-radius:18px;box-shadow:0 24px 60px rgba(40,20,90,0.16),0 4px 14px rgba(0,0,0,0.05);overflow:hidden;animation:kvfloat 7s var(--kv-ease-in-out) infinite">
        <div style="display:flex;align-items:center;gap:7px;padding:11px 14px;border-bottom:1px solid var(--kv-border-subtle);background:var(--kv-neutral-50)">
          ...
          <span style="margin-left:10px;font-size:11px;color:var(--kv-text-tertiary);background:#fff;border:1px solid var(--kv-border-subtle);padding:3px 12px;border-radius:999px">kinevoapp.com/dashboard</span>
        </div>
          ...
          <div style="display:flex;align-items:center;gap:11px;margin-bottom:13px">
            <div style="flex:1">
              ...
              <div style="display:flex;gap:6px;margin-top:5px">
                <span style="font-size:10px;font-weight:600;color:var(--kv-success);background:var(--kv-success-soft);padding:2px 8px;border-radius:999px">● 12 alunos ativos</span>
                <span style="font-size:10px;font-weight:600;color:var(--kv-text-secondary);background:var(--kv-neutral-100);padding:2px 8px;border-radius:999px">Hoje · 5 sessões</span>
              </div>
            </div>
      ...
      <!-- Phone -->
      <div style="position:absolute;z-index:3;bottom:-46px;left:-34px;animation:kvfloat2 6s var(--kv-ease-in-out) infinite"><div id="kvlp-hero-phone"></div></div>
      <!-- Watch -->
      <div style="position:absolute;z-index:4;top:-12px;right:-24px;animation:kvfloat 5.5s var(--kv-ease-in-out) infinite"><div id="kvlp-hero-watch"></div></div>
    </div>
  </div>
</section>
...
<div style="border-top:1px solid var(--kv-border-subtle);border-bottom:1px solid var(--kv-border-subtle);background:#fff;padding:18px 0;overflow:hidden;position:relative">
  ...
  <div class="kvmq" style="display:flex;gap:14px;width:max-content">
    <div style="display:flex;gap:14px;flex-shrink:0;padding-right:14px">
      ...
      <span style="display:inline-flex;align-items:center;gap:9px;flex-shrink:0;white-space:nowrap;font-size:14px;font-weight:600;color:var(--kv-text-primary);background:var(--kv-neutral-100);border:1px solid var(--kv-border-subtle);padding:9px 16px;border-radius:999px"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:16px;height:16px;color:var(--kv-brand-600)"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"/><path d="M20 2v4"/><path d="M22 4h-4"/><circle cx="4" cy="20" r="2"/></svg>IA que aprende seu estilo</span>
...
<section class="sec" style="padding:96px 0;background:linear-gradient(180deg,#0d0d17,#15102b);color:#fff;position:relative;overflow:hidden">
  <div style="position:absolute;top:-80px;left:10%;width:420px;height:420px;border-radius:50%;background:rgba(124,58,237,0.28);filter:blur(120px);pointer-events:none"></div>
  <div style="position:absolute;bottom:-120px;right:5%;width:380px;height:380px;border-radius:50%;background:rgba(168,85,247,0.18);filter:blur(120px);pointer-events:none"></div>
  <div style="position:relative;max-width:1180px;margin:0 auto;padding:0 24px">
    <div data-reveal="" style="text-align:center;max-width:820px;margin:0 auto 14px">
      <div style="display:inline-flex;align-items:center;gap:7px;font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#c4b5fd;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);padding:6px 14px;border-radius:999px;margin-bottom:20px"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:13px;height:13px"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"/><path d="M20 2v4"/><path d="M22 4h-4"/><circle cx="4" cy="20" r="2"/></svg>O assistente que executa</div>
      <h2 class="display-xl" style="font-size:46px;font-weight:800;letter-spacing:-0.03em;line-height:1.08;margin:0;color:#fff">Você conversa. <span style="background:linear-gradient(120deg,#a78bfa,#d8b4fe);-webkit-background-clip:text;background-clip:text;color:transparent">Ele faz o trabalho.</span></h2>
    </div>
    ...
    <div data-reveal="" style="max-width:680px;margin:0 auto 36px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.12);border-radius:22px;padding:8px;backdrop-filter:blur(8px);box-shadow:0 30px 70px rgba(0,0,0,0.4)">
      <div style="display:flex;align-items:center;gap:9px;padding:13px 16px 12px">
        <span style="width:28px;height:28px;border-radius:8px;background:linear-gradient(135deg,#7c3aed,#a855f7);display:flex;align-items:center;justify-content:center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:15px;height:15px;color:#fff"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"/><path d="M20 2v4"/><path d="M22 4h-4"/><circle cx="4" cy="20" r="2"/></svg></span>
      ...
      <div style="background:rgba(0,0,0,0.25);border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:16px;min-height:264px;display:flex;flex-direction:column;gap:12px">
        ...
        <div data-kv="agThink" class="kvhide" style="align-self:flex-start;display:flex;align-items:center;gap:9px;background:rgba(255,255,255,0.06);border-radius:14px;padding:10px 14px">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:15px;height:15px;color:#a78bfa"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"/><path d="M20 2v4"/><path d="M22 4h-4"/><circle cx="4" cy="20" r="2"/></svg><span style="font-size:13px;color:rgba(255,255,255,0.75)">Entendi. Executando…</span>
        </div>
        <!-- step 1 -->
    ...
    <div class="four-col" data-reveal="" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px">
      <div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:18px;padding:22px">
        ...
        <div style="display:flex;align-items:center;gap:8px;margin:0 0 8px"><h3 style="font-size:16.5px;font-weight:700;margin:0;color:#fff">Resumo da manhã</h3><span style="font-size:9.5px;font-weight:700;letter-spacing:0.04em;color:#c4b5fd;border:1px solid rgba(255,255,255,0.2);padding:2px 7px;border-radius:999px">Pro</span></div>
    ...
    <div class="two-col" style="display:grid;grid-template-columns:1fr 1.1fr;gap:52px;align-items:center">
      <div data-reveal="">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:8px">
          <span style="font-size:13px;font-weight:600;color:var(--kv-text-primary);background:#fff;border:1px solid var(--kv-border-subtle);padding:7px 13px;border-radius:999px;box-shadow:var(--kv-shadow-xs)">Drop-set</span>
          <span style="font-size:13px;font-weight:600;color:var(--kv-text-primary);background:#fff;border:1px solid var(--kv-border-subtle);padding:7px 13px;border-radius:999px;box-shadow:var(--kv-shadow-xs)">Pirâmide</span>
          <span style="font-size:13px;font-weight:600;color:var(--kv-text-primary);background:#fff;border:1px solid var(--kv-border-subtle);padding:7px 13px;border-radius:999px;box-shadow:var(--kv-shadow-xs)">Cluster</span>
          <span style="font-size:13px;font-weight:600;color:var(--kv-text-primary);background:#fff;border:1px solid var(--kv-border-subtle);padding:7px 13px;border-radius:999px;box-shadow:var(--kv-shadow-xs)">5×5</span>
          <span style="font-size:13px;font-weight:600;color:var(--kv-text-primary);background:#fff;border:1px solid var(--kv-border-subtle);padding:7px 13px;border-radius:999px;box-shadow:var(--kv-shadow-xs)">Top + back-off</span>
          <span style="font-size:13px;font-weight:600;color:var(--kv-text-primary);background:#fff;border:1px solid var(--kv-border-subtle);padding:7px 13px;border-radius:999px;box-shadow:var(--kv-shadow-xs)">Supersets</span>
          <span style="font-size:13px;font-weight:600;color:var(--kv-text-primary);background:#fff;border:1px solid var(--kv-border-subtle);padding:7px 13px;border-radius:999px;box-shadow:var(--kv-shadow-xs)">Carga por série</span>
        </div>
      </div>
      ...
      <div data-reveal="" style="background:#fff;border:1px solid var(--kv-border-subtle);border-radius:22px;box-shadow:var(--kv-shadow-lg);overflow:hidden">
        <div style="display:flex;align-items:center;gap:9px;padding:14px 18px;border-bottom:1px solid var(--kv-border-subtle);background:var(--kv-neutral-50)">
          <span style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:700;color:var(--kv-brand-700);background:var(--kv-brand-50);padding:5px 11px;border-radius:999px"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:13px;height:13px"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"/><path d="M20 2v4"/><path d="M22 4h-4"/><circle cx="4" cy="20" r="2"/></svg>Cole seu treino</span>
    ...
    <div class="two-col" style="display:grid;grid-template-columns:1.05fr 1fr;gap:52px;align-items:center">
      ...
      <div data-reveal="" style="order:0;background:#fff;border:1px solid var(--kv-border-subtle);border-radius:22px;box-shadow:var(--kv-shadow-lg);padding:18px">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px">
          ...
          <span style="font-size:11px;font-weight:600;color:var(--kv-text-tertiary);background:var(--kv-neutral-100);padding:4px 10px;border-radius:999px">4 alunos</span>
        </div>
    ...
    <div class="two-col" style="display:grid;grid-template-columns:1fr 1fr;gap:52px;align-items:center">
      <div data-reveal="">
        ...
        <div style="background:var(--kv-brand-50);border:1px solid var(--kv-brand-200);border-radius:16px;padding:16px 18px;margin-bottom:22px">
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:17px;height:17px;color:var(--kv-brand-700)"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"/></svg><span style="font-size:13.5px;font-weight:700;color:var(--kv-brand-800)">Conecta com Strava e Oura</span><span style="font-size:9.5px;font-weight:700;color:#fff;background:var(--kv-brand-600);padding:2px 7px;border-radius:999px">NOVO</span></div>
      ...
      <div data-reveal="" style="position:relative;display:flex;justify-content:center;align-items:center;min-height:440px">
        ...
        <!-- watch -->
        <div style="position:absolute;right:-16px;bottom:14px;animation:kvfloat 5s var(--kv-ease-in-out) infinite"><div id="kvlp-aluno-watch"></div></div>
      </div>
    </div>
  </div>
</section>
  ...
  <div style="max-width:1180px;margin:0 auto;padding:0 24px">
    ...
    <div class="biz-grid" data-reveal="" style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px">
      <div style="background:#fff;border:1px solid var(--kv-border-subtle);border-radius:20px;padding:28px;box-shadow:var(--kv-shadow-sm)">
        ...
        <div style="display:inline-block;font-size:11px;font-weight:700;color:var(--kv-success);background:var(--kv-success-soft);padding:3px 10px;border-radius:999px;margin-bottom:12px">Kinevo não tira %</div>
      ...
      <div style="background:#fff;border:1px solid var(--kv-border-subtle);border-radius:20px;padding:28px;box-shadow:var(--kv-shadow-sm)">
        ...
        <div style="display:inline-block;font-size:11px;font-weight:700;color:var(--kv-brand-700);background:var(--kv-brand-50);padding:3px 10px;border-radius:999px;margin-bottom:12px">Sincroniza com o Google</div>
      ...
      <div style="background:#fff;border:1px solid var(--kv-border-subtle);border-radius:20px;padding:28px;box-shadow:var(--kv-shadow-sm)">
        ...
        <div style="display:inline-block;font-size:11px;font-weight:700;color:var(--kv-accent-blue);background:var(--kv-accent-blue-soft);padding:3px 10px;border-radius:999px;margin-bottom:12px">Gerados por IA</div>
...
<section class="sec" style="padding:92px 0;background:#fff;border-top:1px solid var(--kv-border-subtle)">
  <div style="max-width:1080px;margin:0 auto;padding:0 24px">
    <div data-reveal="" style="position:relative;background:var(--kv-surface-card);border:1px solid var(--kv-border-subtle);border-radius:28px;box-shadow:0 24px 60px rgba(80,40,160,0.10);overflow:hidden">
      <div style="position:absolute;top:-90px;right:-60px;width:320px;height:320px;border-radius:50%;background:rgba(124,58,237,0.12);filter:blur(90px);pointer-events:none"></div>
      <div class="biz-grid" style="position:relative;display:grid;grid-template-columns:0.78fr 1.22fr;gap:0;align-items:stretch">
        <div style="position:relative;min-height:380px;background:linear-gradient(160deg,#2a2150,#15102b)">
          ...
          <div style="position:absolute;left:20px;bottom:18px;display:flex;align-items:center;gap:10px;background:rgba(13,13,23,0.62);backdrop-filter:blur(6px);border:1px solid rgba(255,255,255,0.12);border-radius:999px;padding:7px 14px 7px 8px;z-index:2">
            <span style="width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,#7c3aed,#a855f7);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:800;color:#fff">G</span>
...
<section class="sec" style="padding:40px 0 96px">
  <div style="max-width:1180px;margin:0 auto;padding:0 24px">
    <div data-reveal="" style="position:relative;overflow:hidden;background:linear-gradient(135deg,#3730A3,#7C3AED 55%,#A855F7);border-radius:32px;padding:64px 32px;text-align:center;color:#fff;box-shadow:var(--kv-shadow-brand)">
      <div style="position:absolute;top:-60px;left:-40px;width:280px;height:280px;border-radius:50%;background:rgba(255,255,255,0.12);filter:blur(60px)"></div>
      ...
      <a href="https://www.kinevoapp.com/signup" style="position:relative;display:inline-flex;align-items:center;gap:9px;padding:16px 34px;font-size:17px;font-weight:700;color:var(--kv-brand-700);background:#fff;border-radius:999px;box-shadow:0 8px 28px rgba(0,0,0,0.18);transition:transform .15s" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform=''">Criar minha conta grátis<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:19px;height:19px"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></a>
...
<!-- ░░░ FOOTER ░░░ -->
<footer style="background:#0d0d17;color:rgba(255,255,255,0.7);padding:56px 0 32px">
  <div style="max-width:1180px;margin:0 auto;padding:0 24px">
