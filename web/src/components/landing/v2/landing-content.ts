...
<header style="position:sticky;top:0;z-index:20;backdrop-filter:saturate(180%) blur(14px);-webkit-backdrop-filter:saturate(180%) blur(14px);background:rgba(255,255,255,0.78);border-bottom:1px solid var(--kv-border-subtle)">
  <nav style="max-width:1180px;margin:0 auto;padding:0 24px;height:66px;display:flex;align-items:center;justify-content:space-between;gap:24px">
    ...
    <div style="display:flex;align-items:center;gap:10px">
      <a href="/login" style="padding:9px 16px;font-size:14px;font-weight:600;color:var(--kv-text-secondary);border-radius:999px;transition:background .2s" onmouseover="this.style.background='var(--kv-neutral-100)'" onmouseout="this.style.background=''">Entrar</a>
      <a href="/signup" style="padding:10px 20px;font-size:14px;font-weight:600;color:#fff;background:var(--kv-brand-600);border-radius:999px;box-shadow:var(--kv-shadow-brand-sm);transition:transform .15s,box-shadow .2s" onmouseover="this.style.transform='translateY(-1px)';this.style.boxShadow='var(--kv-shadow-brand)'" onmouseout="this.style.transform='';this.style.boxShadow='var(--kv-shadow-brand-sm)'">Começar grátis</a>
    </div>
  </nav>
</header>
  ...
  <div id="hero-grid" style="position:relative;max-width:1180px;margin:0 auto;padding:0 24px;display:grid;grid-template-columns:1.04fr 1fr;gap:56px;align-items:center">
    <div>
      ...
      <div id="hero-cta" style="display:flex;flex-wrap:wrap;gap:14px;margin-bottom:18px">
        <a href="/signup" style="display:inline-flex;align-items:center;gap:9px;padding:15px 28px;font-size:16px;font-weight:700;color:#fff;background:var(--kv-brand-600);border-radius:999px;box-shadow:var(--kv-shadow-brand);transition:transform .15s" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform=''">Começar grátis<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></a>
...
<section class="sec" style="padding:40px 0 96px">
  <div style="max-width:1180px;margin:0 auto;padding:0 24px">
    <div data-reveal="" style="position:relative;overflow:hidden;background:linear-gradient(135deg,#3730A3,#7C3AED 55%,#A855F7);border-radius:32px;padding:64px 32px;text-align:center;color:#fff;box-shadow:var(--kv-shadow-brand)">
      ...
      <a href="/signup" style="position:relative;display:inline-flex;align-items:center;gap:9px;padding:16px 34px;font-size:17px;font-weight:700;color:var(--kv-brand-700);background:#fff;border-radius:999px;box-shadow:0 8px 28px rgba(0,0,0,0.18);transition:transform .15s" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform=''">Criar minha conta grátis<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="width:19px;height:19px"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></a>
