        ...
        <section id="philosophy" className="py-24 bg-slate-900/50">
            <div className="container mx-auto px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Nossa Filosofia</h2>
                ...
                >
                    {cards.map((card, index) => (
                        <motion.div
                            ...
                            className="bg-slate-950/50 border border-slate-800 p-8 rounded-[32px] hover:border-violet-500/30 transition-colors group"
                        >
                            <div className="mb-6 p-4 bg-slate-900 border border-slate-800 w-fit rounded-2xl group-hover:scale-110 transition-transform">
                                {card.icon}
                            </div>
