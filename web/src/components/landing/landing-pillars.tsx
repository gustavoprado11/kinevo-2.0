...
const pillars: Pillar[] = [
    {
        ...
        icon: ClipboardEdit,
        label: 'Prescrição',
        title: 'Programas completos em minutos.',
        description:
            'Construtor visual com supersets, periodização real e assistente IA que aprende o seu estilo.',
        bullets: [
            'Supersets, notas e substituições pré-aprovadas',
            'Periodização em 4 fases reais',
            'Formulários inteligentes prontos',
    ...
    },
    {
        ...
        title: 'Saiba quem treinou e quem precisa de atenção.',
        description:
            'Dashboard de aderência em tempo real. Sala de Treino para acompanhar múltiplos alunos na academia.',
        bullets: [
            'Aderência com %, streaks e sparklines',
            'Sala de Treino em tempo real',
            'Notificações push automáticas',
            'Inbox unificado do aluno',
        ],
    ...
    },
    {
        ...
        icon: DollarSign,
        label: 'Financeiro',
        title: '100% seu. Zero taxa Kinevo.',
        description:
            'Cobranças automáticas via Stripe. Veja seu MRR em tempo real.',
        bullets: [
            '0% taxa Kinevo — só Stripe padrão',
            'Cobranças recorrentes e avulsas',
            'Bloqueio automático por inadimplência',
            'Dashboard financeiro com MRR',
        ],
        image: null,
