    ...
    return (
        <div className="bg-gray-800/50 rounded-xl border border-gray-700/50 p-6">
            <div className="flex items-center justify-between mb-4">
                <div>
                    <h2 className="text-lg font-semibold text-white">Histórico de Treinos</h2>
                    <p className="text-sm text-gray-400 mt-0.5">Registro completo de atividades</p>
                </div>
            ...
            <div className="border border-dashed border-gray-700 rounded-xl p-8 text-center">
                ...
                <p className="text-gray-400 mb-2">Histórico completo de treinos</p>
