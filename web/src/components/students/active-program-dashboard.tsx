                ...
                <div className="flex items-start justify-between mb-8">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-k-text-tertiary hover:text-k-text-primary hover:bg-glass-bg-active rounded-xl transition-all border border-k-border-subtle flex items-center gap-1.5"
                        >
