            ...
            <div className="bg-gray-800/50 rounded-xl border border-gray-700/50 p-6 h-full flex flex-col">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-400 mt-0.5">Nenhum programa ativo no momento</p>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-white mb-2">Comece um novo ciclo</h3>
    ...
    return (
        <div className="bg-gray-800/50 rounded-xl border border-gray-700/50 p-6">
                ...
                <div className="flex items-center gap-6 text-sm">
                    {program.started_at && (
                        <div className="flex items-center gap-2 text-gray-400">
                            ...
                            <span>Início: <span className="text-gray-300">{new Date(program.started_at).toLocaleDateString('pt-BR')}</span></span>
                        </div>
                    )}
                    {program.duration_weeks && (
                        <div className="flex items-center gap-2 text-gray-400">
                            ...
                            <span>Duração: <span className="text-gray-300">{program.duration_weeks} semanas</span></span>
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                {/* Total Sessions */}
                <div className="bg-gray-900/30 rounded-xl border border-gray-700/30 p-4 flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-2xl font-bold text-white leading-none">{summary.totalSessions}</p>
                        <p className="text-xs text-gray-400 mt-1">Treinos totais</p>
                    </div>
                </div>
                ...
                <div className="bg-gray-900/30 rounded-xl border border-gray-700/30 p-4 flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-2xl font-bold text-white leading-none">{summary.completedThisWeek}</p>
                ...
                <div className="bg-gray-900/30 rounded-xl border border-gray-700/30 p-4 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1">Último treino</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex flex-col space-y-2">
                        {recentSessions.map((session) => (
                            <button
                                ...
                                className="w-full bg-gray-900/30 hover:bg-gray-800/50 border border-gray-700/30 hover:border-violet-500/30 rounded-xl p-3 flex items-center justify-between transition-all group text-left"
                            >
