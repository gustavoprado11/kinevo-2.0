-- ============================================================================
-- Kinevo — 052 Fix Training Room RPC: empty string UUIDs
-- ============================================================================
-- The get_student_today_workout_for_trainer RPC used COALESCE(exercise_id, '')
-- which produced empty strings instead of NULLs in JSONB when exercise_id was
-- NULL. This caused "invalid input syntax for type uuid" errors downstream.
-- Fix: return NULL instead of empty string for exercise IDs.
-- ============================================================================
